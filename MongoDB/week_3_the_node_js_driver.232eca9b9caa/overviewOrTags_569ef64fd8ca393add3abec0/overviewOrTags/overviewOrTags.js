...
function queryDocument(options) {
    ...
    if ("overview" in options) {
        ...
        */
        ...
        // query.overview = {$or: [{"overview": {"$regex": options.overview} },{"tag_list": {"$regex": options.overview} } ] }

        query["$or"] = [{"overview": {"$regex": options.overview, "$options": "i"} },{"tag_list": {"$regex": options.overview} } ]
